-- =====================================================
-- GladGrade Content Moderation Schema
-- =====================================================
...
-- =====================================================
-- 4. Add moderation fields to gg.ads
-- =====================================================
DO $$ 
BEGIN
    -- Add moderation_status_id column
...
-- =====================================================
-- 5. Create Client-User Communications Table
-- =====================================================
CREATE TABLE IF NOT EXISTS gg.client_user_communications (
    ...
    communication_type VARCHAR(50) DEFAULT 'review_response', -- review_response, complaint, inquiry
...
-- =====================================================
-- 6. Update existing records to have default moderation status
-- =====================================================
...
-- =====================================================
-- 7. Create views for easy moderation queries
-- =====================================================
...
LEFT JOIN gg.businesses b ON i.placeid = b.placeid
...
LEFT JOIN gg.businesses b ON a.placeid = b.placeid
